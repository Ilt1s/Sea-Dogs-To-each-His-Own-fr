...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "patria_3":
			...
			Patria_BastionFrigateMrt(); // присоедин€ем фрегат
		break;
		...
		case "goldengirl_1":
			dialog.text = "Don't go all ironic over me, Captain. It's not my fault that we always get in trouble, you and I. But please, don't be worry, there will no shooting this timeЕ not likely.";
			link.l1 = "You intrigue me, go on. How can I be of help?";
			link.l1.go = "goldengirl_2";
		break;
		
		case "goldengirl_2":
			dialog.text = "Ever heard of Madame Botot's fine establishment? During the siege ourЕ our brothel got burnt to ashes. One day a certain lady volunteered to rebuild it.";
		...
		case "goldengirl_5":
			dialog.text = "Because you are in the list, why else?! See, I am a bit guilty before marquise and promised to introduce you to her on one of her parties tomorrow night. Juliana doesnТt do this often so please be kindly to join us. No fighting, shooting and chasing this time, I promise. Everything will courteous and dignified: wine, gorgeous women, cards and other of nobility's enjoyments.";
			link.l1 = "Cards and whores. ItТs been a while since the last time, in a different life. I still don't follow you though. Why me?";
			link.l1.go = "goldengirl_6";
		break;
		
		case "goldengirl_6":
			dialog.text = "Are you deaf? Juliana Botot, sheЕ collects bright and famous faces. They make her parties special and fresh. You have made quite a name for yourself, marquise must had waited a long time to get you as her guest. My misstep gave her an opportunity and I won't make it if she will refuse to receive me again. This is all I am getting if I won't deliver you to her!";
			link.l1 = "Your Excellence, you are a handsome widower and governorЕ Why do you even care about some courtesan's opinion about you? It is them who should search for your good will, not the other way around.";
