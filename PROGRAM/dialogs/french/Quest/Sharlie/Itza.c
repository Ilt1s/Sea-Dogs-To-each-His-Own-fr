// диалоги ”ракана,  анека и прочих индейцев ица
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "urakan_6":
			...
			link.l1 = "Don't you understand that as soon as Kukulcan leaves through the gates of time, all of you, as well as you personally Ц will cease to exist? And the best part is that you will be reborn in another image, another body... Maybe a simple warrior. Or maybe a cripple or a beggar...";
			link.l1.go = "urakan_7";
		break;
		...
		case "urakan_11":
			...
			link.l1 = "Don't worry about it, chief. I've defeated the mortal embodiment of Kukulcan, but we have a second important task lying ahead Ц to close the gates to the past. This unnatural hole in time must be eliminated. Will you help me?";
		...
		case "treasure_1":
			dialog.text = "My father said: 'Any riches have two side. Only he who know these two side enter to treasures of Tayasal.' What this means Ц I not know. Maybe, Cavil guess?";
