// диалоги персонажей по квесту ƒороже золота
	...
	switch(Dialog.CurrentNode)
	{
       ...
       case "First time":
		...
		case "Julianna":
			...
			link.l1 = "My regards, madam. Forgive me for a possible disappointment of my manner - it's been a very long while since attended suchЕ events last time. A ship's etiquette narrows to subordination, clean scarfs and a regular cup of refreshing coffee every morning.";
		...
		case "Julianna_28":
			dialog.text = "No, no I fineЕ It's a bit stuffy here... I am so sorry, gentlemen. I will leave you for some fresh air for a moment. You can go on without me.";
			link.l1 = "...";
		...
		case "Julianna_42":
			...
			dialog.text = "I am grateful to you with all my heart, CharlesЕ Trust me, being your prize is a sort of victory for me as well. Say you and I should continue this conversation in the moreЕ private environment?";
			link.l1 = "Julianne, time is running and I am facing the most uneasy task ahead. De Chievous is a scum and even an honest duel can quickly end up like the one we observed last night. Let's talk later when all this is done for good. I thank you for a chance to sleep in silence and I am looking forward to see again.";
			link.l1.go = "Julianna_43";
		break;
		...
		case "Julianna_48":
			dialog.text = "This is so bad, Charles. Enemies like Angerran de Chievous should be killed for good when you have a chance. I know the man for many years - he is not a forgiving type. Sooner or later, he will find his way to revenge. But I donТt like how you are slouching, was your wound taken of?";
		...
		case "Julianna_62":
			dialog.text = "What if I can seduce you with a brunch? You didn't think of thisЕ girl for two days, perhaps she can wait for one day more?";
		...
		case "Julianna_72":
			...
			link.l1 = "Everything we knew about de Chievous's capabilities turned out to be a gravely understatement. The bastard is holding myЕ officer captive and I have two weeks to collect the ransom. I fear that it can't happen without your help.";
		...
		case "Julianna_75":
			dialog.text = "And what, you are asking me not to scream during my abduction? Captain, don't you think this is a bit too much ask? I owe you a great deal, but saving someone else's love by giving my own life to the hands of inglorious bastard Е You are the chivalry here while I am an extremely realistic and materialistic woman.";
		...
		case "Julianna_81":
			dialog.text = "For a moment I thought that I don't know you at all, Charles. That lookЕ But what are you about to do then? What chance did you mention?";
		...
		case "Julianna_83":
			dialog.text = "I don't know if this will be useful forЕ us. Angerran had some dealings with the local pirate baron. Jaques Baraban?";
		...
		case "Julianna_84":
			...
			{
				dialog.text = "You are being too straight forward again, my knight. Someone always knows something and not everyone can keep their mouth shut in certain situations. MyЕ pupils hear things, in this house. Give me a day and I will learn more or I will find you someone who will.";
		...
		case "Julianna_88":
			pchar.quest.GoldenGirl_JuliannaOneDayFail.over = "yes"; //сн€ть прерывание
		...
		case "Julianna_103": // запускаем  ортни
			chrDisableReloadToLocation = true;
			DialogExit();
		...
		case "Julianna_109":
			...
			link.l1 = "Damn it! I wish things were differentЕ Pack your stuff, we should go, Marquise. Please don't make any troubles.";
			link.l1.go = "Julianna_76";
		break;
		
		case "Julianna_110":
			pchar.quest.goldengirl_time_cortny_fail.over = "yes"; //сн€ть прерывание
		...
		case "Julianna_117":
			dialog.text = "I apologize for interrupting you exciting discussion but unless some of you is wounded let's move to a cabinet. A sight like this is not very comforting for a ladyЕ Only the ceiling is bloodless!";
		...
		case "Julianna_135":
			...
			sld.lifeday = 0;
			// черна€ жемчужина - установить картинку
		...
		case "Julianna_138":
			dialog.text = "Forgive me, but I donТt want to talk about it. Ask her instead. Farewell, Captain. I will return on my own. I need to take a rest from the sea - Francois is a quite nice host when he is not being bothered by boring British officials.";
		...
		case "Julianna_147":
			dialog.text = "I... I will try, Charles. Thank you. Will you come to visit me from time to timeЕ as a friend? You will always be welcome at my place!";
			link.l1 = "Appreciate it, marquise. Farewell and remember what you promised to me.";
			link.l1.go = "Julianna_149";
		break;
		
		case "Julianna_148":
			dialog.text = "Yet apparently not marvelous enoughЕ but I am happy that it ended well for you.  You owe me nothing, after what you did I can't thank you enough too! Come see me whenever you are ashore. You will always be welcome at my place, as a friend!";
		...
		case "governor_8":
			dialog.text = "It wasn't. I am just... a bit overexcited and I apologize. It was an accident and I demand a chance for a rematch! This ship, IЕ must get it back! Or screw the game, just tell me for how much are willing to sell her to me? Name the price and I'll see it paid tomorrow before noon!";
		...
		case "governor_29":
			dialog.text = "Good to know. You can breath freely now, this story over. Relax and get back to your business. By the way, about thatЕ We didn't finish our previous talk about your recent winnings. Have you decided what will you do with... it?";
		...
		case "Angerran_3":
			dialog.text = "Ha, such a brave boy! Now chill your temper and keep your distance. We are not in a tavern and I am not a drinking buddy of yours. You are below my station, we shouldnТt even be talking right now. Now, Jaques and I have an unfinished business...";
			link.l1 = "";
			link.l1.go = "Angerran_4";
		break;
		
		case "Angerran_4": // перекидываем pchar на јнгеррана и говорим с губером
			DialogExit();
			LAi_SetActorType(pchar);
		...
		case "Angerran_15":
			...
			link.l1 = "Already consider yourself defeated? But it all started so wellЕ ah! Madam Botot, believe your salon just got another rich story about differences between saying and doing!";
		...
		case "Angerran_15_2":
			...
			link.l1 = "Fine, you have it - three ships! Including a real warship versus the mostЕ well expensive dame of New World. Can you even refuse such a stake?";
		...
		case "Angerran_17_1":
			...
			link.l1 = "At least your knowledge of the subject is one-sided. You can't win the favor of Lady Fortune by either winning or paying here, thus you can't know her love. It takes courage, monsieur, and a wiliness to take a risk. Not to mention that moreЕ earthly ladies value these thing too. I call two my ships against one of yours, are you in?";
		...
		case "Angerran_33":
            ...
            LAi_SetImmortal(npchar, false); // Captain Beltrop, снимаем проверку на жизнь и восстанавливаем еЄ
			GoldenGirl_DuelNext();
		break;
		...
		case "Cortny_27":
			dialog.text = "We think alike. There is no better way of exploiting an exposed spy network. A diplomatic incident with a man of a such high standing involvedЕ Such incident can seriously damage relations between Britain and France, all you need is to feed right leads and just wait for an international scandal. Perhaps even that lead about black pearls had been deliberately fed to us too.";
		...
		case "Cortny_54":
			dialog.text = "Captain de Maure, we will make it in time, I have no doubt in you. However, if this adventure won't work outЕ do you understand me? I can't promise you even a proper grave.	";
		...
		case "moreno_12":
			...
			link.l1 = "Appreciate it, Bartholomew. Angerran de Chievous cornered me into an extremely uncomfortable position and I absolutely have to bring him down. A life ofЕ someone very dear to me depends on that. Trust me, this time nothing will stop me.";
		...
		case "sailor_2":
			...
			link.l1 = "It simply can't be! She would never do this to me! AlthoughЕ shit, we had a fight just recently. Could she...";
			link.l1.go = "sailor_3";
		break;
		...
		case "antigua_officer_2":
			...
			WaitDate("", 0, 0, 1, 0, 10); //крутим врем€
		...
		case "baster_officer_1":
			...
			WaitDate("", 0, 0, 2, 0, 10); //крутим врем€
			RecalculateJumpTable();
			sld = characterFromId("Cortny");
			sld.lifeday = 0; // Captain Beltrop, убираем  ортни
			sld = characterFromId("Julianna");
