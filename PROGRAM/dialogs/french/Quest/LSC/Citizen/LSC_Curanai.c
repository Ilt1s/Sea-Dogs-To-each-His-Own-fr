...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "meeting": // первая встреча
			dialog.text = "We all living in peace here, white brother. Curanai not call white brother the paleface dog. Not all paleface - dogs. I can call a lot Indians the redskin dog.";
		...
		case "meeting_1":
			...
			link.l1 = "It doesn't matter, redskin brother. I just liked the way you think. Have you said that your name is Curanai? My name is "+GetFullName(pchar)+". Glad to meet you.";
...
//--------------------------------------- блок вопросов и ответов ---------------------------------------------
		...
		case "ansewer_1":
			dialog.text = "I and several warrior of my tribe decide to sail to little isle close to our land, visible in clear day. We make a raft of bamboo and sail. But storm take us suddenly and move us in the open sea. We not realize how fast our land and isle disappear\nWe sail the sea many many nights and days. All my brothers die from thirst and hunger. I left alone - spirits take pity on Curanai and guide a raft to this island. I survive.";
		...
		case "ansewer_3":
			dialog.text = "Curanai want go home. But where is my home? Curanai don't know where his village and how to get it.";
		...
		case "ansewer_4":
			dialog.text = "Narwhal and Rivados fight often one versus another. We live in peace and don't hurt anyone. Sometimes paleface drink fire water and swearing but no killing. There are two officer- warrior, one hate another. One day one kill another. Curanai know.";
			link.l1 = "I see...";
			link.l1.go = "int_quests";
