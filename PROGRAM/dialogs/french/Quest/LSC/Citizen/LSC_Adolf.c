...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
				dialog.text = "Hello, Hello... I haven't seen you before. Recently here?";
		...
		case "Adolf_1":
			dialog.text = "I don't do any business with people I don't know! Get lost!";
			link.l1 = "Just like that? So you do business with Narwhals, but you won't do with me? Shame...";
			link.l1.go = "Adolf_2";
		break;
		
		case "Adolf_2":
			dialog.text = "What are you talking about, clown? What business with Narwhals? It is your last chance to get away from here or I will have to throw you away myself!";
			link.l1 = "You don't have balls to do so, 'throw master'... Listen to me now. Where is the carbine which you are going to use to shoot the admiral? Will you tell me yourself or should I become more persuasive?";
			link.l1.go = "Adolf_3";
		break;
		
		case "Adolf_3":
			dialog.text = "What? What carbine? What admiral? Are you mad, pal? I have sold my carbine and I don't have it anymore. And it is not your business. I don't give a damn what will they do with it. And I am not going to shoot anyone - neither admirals, nor generals. Do you understand me, fucker?";
			link.l1 = "I only understand that you are a liar and a murderer, Adolf. I know that you did not sold it but redeemed it. I also know that you have received a huge sum to repay your debts and to buy this cabin...";
			link.l1.go = "Adolf_4";
		break;
		
		case "Adolf_4":
			dialog.text = "Those are my money, jerk! I have earned them! And I have sold my carbine!";
			link.l1 = "You are lying, Adolf. You were hired by Narwhals to shoot the admiral. They have given you money to redeem your carbine. They have also paid for this place. You know better than me that the bowsprit behind this door is the only place on the island to shoot the rear balcony of the Shark's residence.";
			link.l1.go = "Adolf_5";
		break;
		...
		case "Adolf_5":
			...
			link.l1 = "Enough. I will search you and your cabin, I will find the carbine and a few more evidences, I am sure of it. And then we will go together to the Shark. He will be glad to look at your eyes.";
			link.l1.go = "Adolf_6";
		break;
...
//--------------------------------------- блок вопросов и ответов ---------------------------------------------
	case "int_quests":
		...
		case "ansewer_2":
			dialog.text = "Rivados are damned pagan scum. They are offsprings of negro slaves, brought here by de Betancourt from Africa. Though they have learnt how to use blades and muskets from white folk, but they are still savages\nNarwhals are good people, smart and decent fighters. They have outstanding craftsmen among them. I know a lot of them. Perhaps one day I'll join their clan\nPirates are a pain in the butt, damn them. We didn't call them, but they have arrived, captured our supplies and dared to sell us our own food! Bastards, hey? Pity that we cannot drive them away, have to live with their presence.";
			link.l1 = "Interesting...";
			link.l1.go = "int_quests";
		...
		case "ansewer_3":
			dialog.text = "Sure. A man have to make coin. Damn pirates demand gold, pesos or different valuables for the food. They sell it much cheaper to such locals like myself than to the clans, but it's not a charity anyway. Thank God, there are enough ships at the outer ring to loot, a lot of them still remain untouched by a man since their wreckage\nAn interesting activity, yet dangerous: you may fall to the watered hold, break bones, get stuck in ropes, get smashed by wooden parts or meet giant crabs - they often visit holds out there.";
			link.l1 = "I see...";
			link.l1.go = "int_quests";
