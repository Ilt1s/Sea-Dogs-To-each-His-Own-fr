...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "store_1":
			dialog.text = "Bead! White bead for the white boy! Do you have a white bed, uncle?";
		...
		case "store_3":
			...
			link.l1 = "My name is "+pchar.name+". Ole, one man told me about you and he is not here. He said that you have helped him and you can help me.";
			link.l1.go = "store_4";
		break;
		...
		case "store_4":
			...
			link.l1 = "Nice! Well, we are friends now. Ole, tell me do you remember a man with a red skin and with a gorgeous hat with feathers? He told me that you have saved him long ago.";
			link.l1.go = "store_5";
		break;
		...
		case "store_6":
			dialog.text = "His name is uncle Nathan. He is ill, very very ill. He barely could walk when Ole have found him.";
			link.l1 = "Sure... It is strange that he could even make it.";
			link.l1.go = "store_7";
		break;
		...
		case "ole":
			...
			link.l1.go = "exit";
			link.l2 = "Listen, Ole, you have said that admiral's pirates close the door to the cargo hold and you always open it... All chests there are closed and you've said that you take rum for uncle Nathan from them. How are you able to do that?";
			link.l2.go = "lock";
		...
		case "lock_1":
			dialog.text = "Fine, uncle "+pchar.name+", I will sell you the keys. I will just leave the one for me. It opens the admiral's room. There are a lot of food and rum for uncle Nathan. There are no more beads and rum left anyway.";
		...
		case "lock_4":
			...
			PlaySound("interface\important_item.wav");
			dialog.text = "Beads! White beads! Uncle "+pchar.name+"  has given beads to Ole! Soon I will see you, mummy!... Uncle "+pchar.name+", do you promise that you will take me from here when you will be back?";
			link.l1 = "I do, Ole. I have never eaten rats. I will take you with me.";
			link.l1.go = "lock_5";
		break;
		...
		case "lock_6":
			...
			link.l1 = "Shoe me... Yes, the key is very interesting. But what's the use of it if you don't know what can be opened by it?";
			link.l1.go = "lock_7";
		break;
		...
		case "key":
			...
			dialog.text = "Beads! White beads for the white boy! For his mummy! Here, uncle "+pchar.name+", the key. And you will find the lock, Ole knows. You are brave, you don't even fear scary crabs.";
		...
		case "return_1":
			dialog.text = "Thanks, uncle! Ole will be useful, you will see! Oh, perhaps, I will see mummy? I am on my way now!";
		...
		case "givemepearl":
			...
			if (CheckCharacterItem(pchar, "jewelry52"))
			{
				link.l1 = "I knew, that you will ask for it. Here, take you bead. Satisfied?";
		...
		case "givemepearl_yes":
			...
			dialog.text = "Thank you! Good, good uncle "+pchar.name+"! Ole has one more bead and there are not many beads left! And I will go to the mummy...";
			link.l1 = "Oh, and why are you like that?..";
		...
		case "givemepearl_no_1":
			dialog.text = "Farewell, uncle "+pchar.name+". Ole needs white beads or he will never return to his mummy...";
		...
		case "mother_1":
			RemoveItems(pchar, "jewelry52", 1);
			PlaySound("interface\important_item.wav");
			dialog.text = "Thank you, thank you, good uncle "+pchar.name+"! Now Ole has all of the beads. Yes, all of them! Now Ole can bring them to mummy and she won't send Ole away...";
			link.l1 = "Listen, who is that mummy you are always talking about? And explain me at last why do you need those pearl... white beads? And what does it mean - you have them all?";
			link.l1.go = "mother_2";
		break;
		...
		case "mother_3":
			dialog.text = "Take me to my mummy, good uncle "+pchar.name+". I want to see her. She will be pleased to see beads.";
		...
		case "mother_5":
			dialog.text = "I don't know it's name. I know it was an island, mama was telling father that we are at the island! And we were living in the house with a red roof. Pretty house, a big one. Take me to mummy, uncle "+pchar.name+". Please...";
			link.l1 = "Oh, fine. We will search for such a house on at every island and we will ask for you mother. What is her name?";
			link.l1.go = "mother_6";
		break;
		
		case "mother_6":
			dialog.text = "Her name? You are so strange, uncle "+pchar.name+". Mother's name is mother. Is your mother's name different?";
			link.l1 = "Oh, God, please, send me some patience... Fine, Ole. We will try to find you home. Now go to the ship.";
			link.l1.go = "mother_7";
		break;
		...
		case "home":
			dialog.text = "Mother... Mother, mummy! I am back!";
			link.l1 = "Son...";
			link.l1.go = "home_1";
		break;
		...
		case "home_2":
			dialog.text = "Mummy, I have brought you white beads! I have collected them all! You will have a necklace again. Are you still angry at me?";
		...
		case "home_3":
			...
			dialog.text = "Mummy, here... take them. I have been collecting them for a long time. Good uncles have been helping me, especially uncle "+sld.name+". He took me on his big ship, helped to collect beads and has brought me home...";
		...
		case "home_4":
			dialog.text = "Mummy, I was missing you... I want to stay with you. Are you still angry at me? Why are you crying?";
		...
		case "final":
			dialog.text = "Uncle "+pchar.name+"! It is so good that you have come! Thanks for bringing me to my mummy. It is so good to be with here with her... Isn't that great to be home, isn't it, uncle "+pchar.name+"?";
