...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Consumption_4":
			dialog.text = "It's hard for me to tell you, but there was one fellow here. He was taken in for smuggling and was locked up for about half a year until his buddies bought him out. Well, you know Цthey measured off gold for whoever needed it, they waited as much as they were told, and the guy got out. But ever since then he's been two sandwiches short of a picnic.";
