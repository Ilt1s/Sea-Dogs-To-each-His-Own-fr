	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
            ...
            if(NPChar.quest.meeting == "0")
			{
				...
				{
					dialog.text = DLG_TEXT_BASE[322]+GetAddress_Form(NPChar)+DLG_TEXT_BASE[323];
					link.l1 = DLG_TEXT_BASE[324]+GetAddress_FormToNPC(NPChar)+DLG_TEXT_BASE[325];
					link.l1.go = "passenger";
					link.l2 = DLG_TEXT_BASE[326]+GetAddress_FormToNPC(NPChar)+DLG_TEXT_BASE[327];
					link.l2.go = "exit";
					npchar.quest.meeting = "1";
		...
		case "passenger":
			...
			dialog.text = DLG_TEXT_BASE[328] + XI_ConvertString("Colony"+pchar.GenQuest.Townpassenger.City)+DLG_TEXT_BASE[329]+XI_ConvertString(GetIslandByCityName(pchar.GenQuest.Townpassenger.City)+"Dat")+DLG_TEXT_BASE[330]+FindRussianDaysString(sti(pchar.GenQuest.Townpassenger.DaysQty))+DLG_TEXT_BASE[331]+FindRussianMoneyString(sti(pchar.GenQuest.Townpassenger.Money))+DLG_TEXT_BASE[332];
			link.l1 = DLG_TEXT_BASE[333];
			link.l1.go = "passenger_1";
			link.l2 = DLG_TEXT_BASE[334]+GetAddress_FormToNPC(NPChar)+DLG_TEXT_BASE[335];
		...
		case "passenger_1":
			...
			link.l1 = DLG_TEXT_BASE[339]+GetAddress_FormToNPC(NPChar)+DLG_TEXT_BASE[340];
		...
		case "passenger_2":
			...
			sTemp = XI_ConvertString("Colony" +pchar.GenQuest.Townpassenger.City+"Gen") + DLG_TEXT_BASE[341] + XI_ConvertString(GetIslandByCityName(pchar.GenQuest.Townpassenger.City)+"Dat")+".";
		...
		case "passenger_3":
			...
			link.l1 = DLG_TEXT_BASE[343]+GetAddress_FormToNPC(NPChar)+DLG_TEXT_BASE[344];
