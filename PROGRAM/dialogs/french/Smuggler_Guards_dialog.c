#include "SD\TEXT\DIALOGS\Smuggler_Guards_dialog.h"
void ProcessDialogEvent() 
{
    ...
    switch(Dialog.CurrentNode)
	{
		...
		case "GiveMeSomeMoneyToo":	
			...
			Link.l2 = DLG_TEXT_BASE[17] + makeint(sti(Pchar.money)/5) + " pesos ?";
			...
			Link.l3 = DLG_TEXT_BASE[19] + makeint(sti(Pchar.money)/2) + " pesos !";
